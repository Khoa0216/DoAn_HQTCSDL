...
public class WindowThongTinThongKe extends JFrame{
    ...
    private void initComponents() {
        ...
        lbThang.setFont(new Font("Serif", Font.PLAIN, 25));
        ...
        lbNam.setFont(new Font("Serif", Font.PLAIN, 25));
        ...
        lbSLVeDaBan.setFont(new Font("Serif", Font.PLAIN, 25));
        ...
        lbTongTien.setFont(new Font("Serif", Font.PLAIN, 25));
        ...
        lbGachNgang.setFont(new Font("Serif", Font.PLAIN, 25));
    ...
    public void setThongTin(int thang, int nam, int soLuongVe, double tongTien) {
        lbThang1.setText(String.valueOf(thang));
        lbNam1.setText(String.valueOf(nam));
        lbSLVeDaBan1.setText(String.valueOf(soLuongVe));
        lbTongTien1.setText(String.format("%.2f", tongTien) + " VND");
    }
    
    public static void main(String[] args) {
        WindowThongTinThongKe window = new WindowThongTinThongKe();
        window.setThongTin(5, 2025, 123, 4567890.50);
