...
public class WindowBanVe extends JPanel{
    ...
    public void btInVeActionPerformed(){
        ...
        if ("Không sử dụng được".equals(chairDTO.getStatus())){
            JOptionPane.showMessageDialog(paneltotal, "Ghế này không sử dụng được");
        }else if(ticketBUS.findByChairIdAndShowtimesId(ticketDTO) != null){
